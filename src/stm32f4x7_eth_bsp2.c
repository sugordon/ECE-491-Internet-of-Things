...
void ETH_BSP_Config(void)
{
  ...
  *****************************************************************************/
  ...
  ETH_GPIO_Config();
  SendData(USART3, "EXECUTED: ETH_GPIO_Config()\n");
  
  /* Configure the Ethernet MAC/DMA */
  ETH_MACDMA_Config();
  SendData(USART3, "EXECUTED: ETH_MACDMA_Config()\n");
  ...
  SendData(USART3, "EXECUTED: ETH_ReadPHYRegister()\n");

  /* Configure the PHY to generate an interrupt on change of link status */
  Eth_Link_PHYITConfig(DP83848_PHY_ADDRESS);
  SendData(USART3, "EXECUTED: ETH_PHYIT_Config()\n");
  
  /* Configure the EXTI for Ethernet link status. */
  Eth_Link_EXTIConfig(); 
  SendData(USART3, "EXECUTING: ETH_EXTI_Config()\n");
}
